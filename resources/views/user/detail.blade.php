                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    {{-- <form action="/addcart" method="post"> --}}
                        ...
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary border-0 text-center" id="jumlah" value="1" name="jumlah">
                            <div class="input-group-btn">
                        ...
                        {{-- <p>{{Auth::user()->id}}</p> --}}
                        <button onclick="addCart({{$data->id}}, {{Auth::user()->id}})" class="btn btn-primary px-3" id="submitJumlah"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                    {{-- </form> --}}
                </div>
