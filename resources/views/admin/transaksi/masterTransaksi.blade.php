...
@endforeach
<div class="card p-4">
    <h2 class="fw-bold mb-4">MASTER TRANSAKSI</h2>
    <table class="table table-bordered table-warning table-striped table-sm table-responsive text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button data-bs-toggle="modal" data-bs-target="#admTrans{{$data->id}}" class="btn btn-secondary rounded-pill p-2 px-4 shadow">detail</button>
            </td>
          </tr>
          @endforeach
        </tbody>
