    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/admin/canceltrans/{{$modaltrans->id}}" class="btn btn-danger rounded-pill text-white"  >batalkan pesanan</a>
                <a href="/admin/completetrans/{{$modaltrans->id}}" class="btn btn-success rounded-pill text-white"  >selesaikan pesanan</a>
            </div>
        </div>
    </div>
</div>
@endforeach
<div class="card p-4">
    <h2 class="fw-bold mb-4">PROSES TRANSAKSI</h2>
    <table class="table table-bordered table-warning table-striped table-sm table-responsive text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Rp. {{$data->total}}</td>
            <td>
              <button data-bs-toggle="modal" data-bs-target="#admTrans{{$data->id}}" class="btn btn-info rounded-pill p-2 px-4 shadow">detail</button>
            </td>
          </tr>
          @endforeach
        </tbody>
